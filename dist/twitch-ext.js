...
function setChannels(usernames) {
    return __awaiter(this, void 0, void 0, function () {
        var usernamesString, resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!_1.config.twitch.extToken) {
                        return [2 /*return*/];
                    }
                    usernamesString = usernames.length ? usernames.join(',') : '';
                    console.log('Attempting to update Twitch extension "Featured Channels" information.');
                    return [4 /*yield*/, needle_1.default('get', "https://api.furious.pro/featuredchannels/bot/" + _1.config.twitch.extToken + "/" + usernamesString)];
                case 1:
                    resp = _a.sent();
